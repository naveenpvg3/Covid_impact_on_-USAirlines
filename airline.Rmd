...
The first smart question helps us fin the top 10 airports having the highest number of passengers. 
...
The Q-Q Plot or a Quantile - Quantile plot is a graphical tool to help us assess of a set of data came from some theoretical distribution such as Normal or Exponential. A Q-Q plot is a scatterplot created by plotting two sets of quantiles against each other. If both sets of quantiles came from the same distribution, we should see the points forming a line that's roughly straight. Here, from the Q-Q plot we can see that half of the data lies below 0 and half of the data lies above 0. By the reference line we can establish that the data is normally distributed.
...
In the third plot, 
the line graph is plotted for monthly average flights from 2015-2020. We see a steady increase in average number of flights from 2015-2018. At the end of 2019 and early 2020 when pandemic started the average number flights reduced.
