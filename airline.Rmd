...
We then run a couple of statistical functions like str(), summary() get the details of the statistical description, variables, datatype,length, etc.
### Importing Data
...
The first smart question helps us understand that we can find the top 10 airports having the highest number of passengers. 
...
```
We can note that JFK stands first in being the busiest airport in the US among all. LAX and MIA have nearly the same values.
